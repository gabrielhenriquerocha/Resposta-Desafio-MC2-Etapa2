                        ...
                        <div class="col-md-8">
                            <table class="table" >
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <th><?php  echo $row['Codigo_Professor']?></th>
                                                <th><?php  echo $row['Nome_Professor']?></th>
                                                <th><?php  echo $row['CPF_Professor']?></th>                                    
                                                <th><?php  echo $row['Datadenascimento_Professor']?></th>
                                                <th><a href="AtualizarProfessor.php?id=<?php echo $row['Codigo_Professor'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="DeletarProfessor.php?id=<?php echo $row['Codigo_Professor'] ?>" class="btn btn-danger">Deletar</a></th>  
